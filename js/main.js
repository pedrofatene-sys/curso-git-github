...
const channels = [
    ...
    { id: 'OlArEishhQg', name: 'Clonando um Repositório' },
    { id: '065NQCDSMb0', name: 'Versionando seus projetos antigos' },
    { id: 'mUZOySyVcuQ', name: 'Você sabe usar Issues?' },
    { id: 'LntSB-gl-ZI', name: 'Guia da Linguagem Markdown' },
    { id: 'bsI6P_IM_hg', name: 'Seu GitHub muito mais seguro' },
    { id: 'xAOBQtSVI_k', name: 'Git Branches de forma fácil e com exemplo' },
    { id: '2Y0HXnYpn9E', name: 'Hospedagem Grátis no GitHub Pages' }
];
